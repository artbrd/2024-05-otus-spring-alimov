...
class JobConfigTest {
    ...
    private List<JpaBook> getExpectedBooks() {
        return List.of(
                new JpaBook(1L, "BookTitle_1", new JpaAuthor(1L, "Author_1")),
                new JpaBook(2L, "BookTitle_2", new JpaAuthor(2L, "Author_2")),
                new JpaBook(3L, "BookTitle_3", new JpaAuthor(3L, "Author_3")));
    }
}